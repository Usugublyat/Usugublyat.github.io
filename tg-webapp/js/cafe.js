  ...
  var Cafe = {
    ...
    mainBtnClicked: function() {
      ...
      if (Cafe.modeOrder) {
        ...
        // var data = $.extend(params, {_auth: authData, method: 'makeOrder'});
        var data = $.extend(params, {
          initData: initData,
          initDataUnsafeHash: Telegram.WebApp.initDataUnsafe.hash,
          method: 'makeOrder'
        });

        Cafe.apiRequest('makeOrder', data, function(result) {
    ...
    apiRequest: function(method, data, onCallback) {
      // var authData = Telegram.WebApp.initDataRaw || '';
      // var data = $.extend(data, {_auth: authData, method: method});
